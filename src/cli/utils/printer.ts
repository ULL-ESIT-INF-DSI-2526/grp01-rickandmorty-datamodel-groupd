...
export function printDimensions(dimensions: import('../../models/interfaces.js').IntDimensiones[]) {
...
export function printLocations(locations: import('../../models/interfaces.js').IntLocalizacion[]) {
...
export function printSpecies(species: import('../../models/interfaces.js').IntEspecies[]) {
...
export function printArtifacts(artifacts: import('../../models/interfaces.js').IntArtefactos[]) {
